...
test('buildCrmTrialSubscriptionData creates a 30-day 100-request trial', () => {
    ...
    assert.strictEqual(data.periodEnd.toISOString(), '2026-07-19T00:00:00.000Z');
...
test('createInitialCrmTrialSubscription persists a first trial and audit log', async () => {
    ...
    assert.strictEqual(result.subscription.periodEnd.toISOString(), '2026-07-19T00:00:00.000Z');
    assert.deepStrictEqual(audits, [
        {
            userId: 'user-1',
